package chapter2.section3.exercise23;
...
public class Quick3way {
    ...
    // Divide the array into three sections, apply medianOfThree to each section, and then apply medianOfThree to the three resulting values.
