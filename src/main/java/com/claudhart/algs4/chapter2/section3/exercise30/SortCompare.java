package com.claudhart.algs4.chapter2.section3.exercise30;
...
public class SortCompare {
    ...
    private static Comparable[] generateArray(String type, int N) {
        if (type.equals("gaussian") || type.equals("poisson") || type.equals("geometric") || type.equals("discrete"))
            return com.claudhart.algs4.chapter2.section1.exercise35.SortCompare.generateArray(type, N);
        else if (type.equals("halfZeroHalfOne") || type.equals("halfZeroHalfReminder") || type.equals("halfZeroHalfRandom")) {
            return com.claudhart.algs4.chapter2.section1.exercise36.SortCompare.generateArray(type, N);
        }
        return null;
    }
}
