package ch2.sec3.ex9;

import ch2.sec3.PrintArrayAndIndices;
...
public class Quick {
    ...
    private static int partition(Comparable[] a, int lo, int hi) {
        ...
        while (true) {
            ...
            PrintArrayAndIndices.print(a, lo, hi, i, j, a[i].toString() + " is not smaller, should on right");
            ...
            PrintArrayAndIndices.print(a, lo, hi, i, j, a[j].toString() + " is not bigger, should on left");
            if (i >= j) {
        ...
        PrintArrayAndIndices.print(a, lo, hi, i, j, "Exchange pivot a[lo] with a[j]");
        exch(a, lo, j);
        PrintArrayAndIndices.print(a, lo, hi, i, j, "After exchange");
